...
######################################################################################
    ...
    if choice == 'Movie recommandation':
        ...
        with col2:
            ...
            fig.update_layout(dragmode=False, title_text='<b> Distribution des films selon les pays </b>', margin=dict(l=40, r=40, b=40, t=40),geo=dict(showframe=False,showcoastlines=False,projection_type='natural earth'))
